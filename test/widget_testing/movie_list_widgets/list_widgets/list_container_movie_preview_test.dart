...
import 'package:movie_card/presentation/widgets/movie_list_presentation/list_widgets/list_container_movie_preview.dart';
...
void main() {
  ...
  testWidgets(
    'Container movie preview list widget test: It should have a card widget that contains a the poster, title, list of genres and the vote average of the movie (list display)',
    (WidgetTester tester) async {
      ...
      Future<void> buildMainPage(WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            routes: {
              '/': (context) => ListContainerMoviePreview(movie: moviePreview),
      ...
      expect(find.byType(ListRowMoviePreview), findsOneWidget);
